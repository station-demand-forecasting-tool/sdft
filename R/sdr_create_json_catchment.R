...
#' a proposed station present in the model.proposed_stations table. The 60-minute service area
...
#' model.abstraction_results table. If \code{abs_crs} is not specified then a \emph{before} catchment
...
#' @param tablesuffix Character. Suffix of the probability table (i.e. the part after "model.probability_")
...
#' @export
sdr_create_json_catchment <- function(type, crs, tablesuffix, abs_crs = NULL, cutoff = 0.01) {
