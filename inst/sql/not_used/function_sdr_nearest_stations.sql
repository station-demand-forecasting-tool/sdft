...
create or replace function openroads.sdr_nearest_stations("origin" "public"."geometry", "expand_min" int8=0, "expand_pc" float4=0.5)
...
begin
	...
	left join lateral openroads.bbox_pgr_dijkstracost(
		$sql$select id,
		source,
		target,
		cost_len as cost,
