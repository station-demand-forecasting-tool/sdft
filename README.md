...
<!-- badges:  start -->
[![Travis build status](https://travis-ci.com/station-demand-forecasting-tool/sdft.svg?branch=master)](https://travis-ci.com/station-demand-forecasting-tool/sdft.svg?branch=master)
